    ...
    public function loadSchoolYears(ObjectManager $manager, FakerGenerator $faker): void
    {
        $schoolYearDatas = [
            [
                ...
                'enddate' => DateTimeImmutable::createFromFormat('Y-m-d', '2022-12-29'),
            ],
            [
                'name' => 'Promo 2023',
                'startdate' => DateTimeImmutable::createFromFormat('Y-m-d', '2023-09-01'),
                'enddate' => DateTimeImmutable::createFromFormat('Y-m-d', '2023-12-29'),
            ],
            [
                'name' => 'Promo 20224',
                'startdate' => DateTimeImmutable::createFromFormat('Y-m-d', '2024-09-01'),
                'enddate' => DateTimeImmutable::createFromFormat('Y-m-d', '2024-12-29'),
            ],
        ];
